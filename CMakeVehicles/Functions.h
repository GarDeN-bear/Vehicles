...
VEHICLESLIBRARY_API DynamicVehicles::Vehicles chooseVehicle(int step, int numberVehicle, std::string& registeredVehicles, DynamicVehicles::Vehicles* vehiclesArray, int& i, float distance);

// Функция регистрации транспортного средства
VEHICLESLIBRARY_API void registerVehicle(int racingType, int step, int& numberVehicle, std::string& registeredVehicles, DynamicVehicles::Vehicles* vehiclesArray, int& i, float distance);
